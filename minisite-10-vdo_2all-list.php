...
<body class="loading minisite">
    ...
    <section class="bg-fgray pt-4 pb-4">
        <div class="container">
            <div class="grids jc-end">
                <div class="grid lg-80 sm-100 mt-0">
<style>
.ss-dash{position:relative;}
.ss-dash::after{content:''; position:absolute; top:calc(50% - .05rem);background-color:#33bbc6; 
left:calc(100% + .5rem); width:2.125rem; height:.1rem; transition:background .25s;}
</style>
                    <h3 class="color-08 d-inline ss-dash">วิดีทัศน์ที่เกี่ยวข้อง</h3>
                    <div class="grids">
                        <?php for($j=1; $j<=3; $j++){?>
