...
<nav class="stopnav">
    ...
    <div class="bottom-container">
        <div class="container">
            <div class="blocks">
                <div class="block hide-mobile op-0">
                    <div class="text">
                ...
                <div class="block">
                    <a class="logo" href="index.php">
                        ...
                        <div class="text-wrapper color-black">
                            <p class="sm">การนิคมอุตสาหกรรมแห่งประเทศไทย</p>
                            <h4 class="lg fw-400 lh-sm">จังหวัดนครศรีธรรมราช</h4>
                        </div>
                    </a>
                </div>
                <div class="block">
...
<!-- Quick Tab -->
<div class="quick-tab style-demo">
    <div class="wrapper">
