...
<head>
    ...
    <style>
        ...
        /* vote table */
        .form-03 {overflow:auto;}
        .table.vote-table {width:100%; min-width:50rem;}
        .table.vote-table tbody {background-color: #313335; }
        .table.vote-table td {border:none;}
    </style>
</head>
<body class="loading">
            ...
            <section class="section-padding pb-0">
                ...
                <div data-aos="fade-up" data-aos-delay="450">
                    ...
                    <form action="./" method="POST">
                        ...
                        <div class="form-02 mt-3 box-shadow">
                            <div class="grids">
                                ...
                                <div class="grid sm-100 mt-0">
                                    <div class="grids px-4 pt-3 pb-5">
                                        ...
                                        <?php }?>
                                        <div class="grid sm-100 mt-0 d-flex ai-center py-1">
                                        <input class="mr-3" type="checkbox" name="choice_3_4" id="others">
                                            <label class="fw-400 text-xl mb-0" for="choice_3_4">อื่นๆ (ระบ)</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <table class="table vote-table">
                                <thead class="px-4 py-3"> 
                                    <tr class="bg-06 color-white">
                                        ...
                                        <td style="min-width: 110px;" class="text-center text-md fw-200">ดีมาก</td>
                                        <td style="min-width: 110px;" class="text-center text-md fw-200">ดี</td>
                                        <td style="min-width: 110px;" class="text-center text-md fw-200">ปานกลาง</td>
                                        <td style="min-width: 110px;" class="text-center text-md fw-200">แย่</td>
                                        <td style="min-width: 110px;" class="text-center text-md fw-200">แย่มาก</td>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php for($i=0; $i< 9; $i++){?>
                                        ...
                                        <tr class="color-white">
                                            <td class="pl-4 text-md fw-200">เป็นเรื่องที่คุณกำลังสนใจในขณะนั้น</td>
                                            <?php for($j= 0; $j<5; $j++){?>
                        ...
                        <div class="mt-3">
                            <p class="pb-3 fw-400">ข้อเสนอแนะของคุณเกี่ยวกับเว็บไซต์การนิคมอุตสาหกรรม</p>
                            <textarea style="background-color:#f1f1f1;" class="w-100" rows="9"></textarea>
                        </div>
                    ...
                    <div class="text-center py-4">
                        <h3 class="sm fw-300 color-02">การนิคมอุตสาหกรรมขอขอบคุณเป็นอย่างยิ่งที่ร่วมแสดงความคิดเห็นกับเรา</h3>
                        <h5 class="fw-100">ทุกความคิดเห็นของตุณมีประโยชน์ในการพัฒนาเว็บไซต์ของเรา</h5>
                    </div>
    ...
    <script>
        $('#others').change(function(){
            let parent = $(this).parent(),
                inputbox = '<input class="py-1 ml-2" style="border-left:none; border-right:none; border-top:none; border-bottom: 1px dotted #888" type="text">';
            if($(this).is(":checked")){
                parent.append(inputbox);
            }else {
                let inputbox = parent.find('input[type="text"]');
                inputbox.remove();
            }
        });
    </script>
