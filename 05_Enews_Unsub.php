...
<head>
    ...
    <style>
        ...
        .bg-07 { background: #8c6ab2; }

        /* Same as in 05_Enews_Sub */
        /* Fields & Inputs */
                    ...
                    <div class="grid xl-80 lg-75 sm-100 mt-0" data-aos="fade-up" data-aos-delay="750">
                        <div class="grids">
                            <div class="grid sm-100">
                                ...
                                <div class="bg-07 px-4 py-3">
                                    <h5 class="fw-200 color-white">แบบฟอร์มยกเลิกสมัครรับข่าวสาร</h3>
                                </div>
                                ...
                                <div class="bg-white px-4 pt-3 pb-4 box-shadow">
                                    ...
                                    <form action="./" method="POST">   
                                        <div class="field">
                                            <div class="control">
                                                <input type="text" placeholder="ป้อนอีเมลของคุณและเลือกจดหมายข่าวที่คุณต้องการยกเลิกการรับสมัครข้อมูล" style="width:80%;">
                                            </div>
                                        </div> 
